<?php
/**
 * WooCommerce Country Product Price Front-End
 *
 * @version 1.0.0
 * @package WCCPP
 */
...
/**
 * WCCPP_Frontend Class
 */
class WCCPP_Frontend {
	...
	public static function init() {
		...
		// add_action( 'wc_country_product_price_before_frontend_init', array( __CLASS__, 'set_customer_country' ), 20 );
